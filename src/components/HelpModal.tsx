            ...
            <div class="flex-1 overflow-y-auto px-5 py-4 pb-6 overscroll-contain">
              <div class="flex flex-col gap-5">
                ...
                <section>
                  ...
                  <p class="pl-5 text-sm text-slate-600 leading-relaxed text-justify">
                ...
                <section>
                  ...
                  <div class="pl-5 space-y-2.5 text-sm text-slate-600 leading-relaxed text-justify">
                    <p><span class="font-semibold text-slate-800">TSV出力を推奨</span>します。CSVをExcelで開くとJANコードの先頭の「0」が消えてしまう問題（0落ち）を防げます。</p>
                    <p>「個数を行展開」をオンにすると、個数が3個の商品は <span class="font-semibold text-slate-800">1個ずつの行として3行</span> 出力されます。システム取り込みの際に便利です。</p>
                    <p>用途に応じて、出力する列（価格や日時など）を自由に絞り込めます。</p>
                  </div>
                </section>
                ...
                <section>
                  ...
                  <div class="pl-5 space-y-2.5 text-sm text-slate-600 leading-relaxed text-justify">
                    <p>スキャン中に画面右下のボタンでライトが点灯します（対応機種のみ）。</p>
                    <p>カメラの映像が真っ暗なままの場合は、スマホまたはブラウザの設定から <span class="font-semibold text-slate-800">カメラへのアクセスを許可</span> してください。</p>
                  </div>
                </section>

                <div class="mt-4 pt-6 border-t border-slate-200/60">
                  <h4 class="mb-3 text-center font-bold text-slate-400 text-xs tracking-widest">DEVELOPMENT & SUPPORT</h4>
                  <div class="flex flex-col gap-2.5">
                    <a
                      href="https://tsukasa-art.com/contact"
                      target="_blank"
                      rel="noopener noreferrer"
                      class="flex items-center justify-between rounded-lg bg-slate-50 px-3.5 py-3 text-sm font-medium text-slate-600 shadow-sm ring-1 ring-slate-200 hover:bg-slate-100 hover:text-blue-600 active:scale-[0.98] transition-all"
                    >
                      お問い合わせ窓口 (HP)
                      <span class="text-slate-400 font-normal">↗</span>
                    </a>
                    <a
                      href="https://github.com/Tuki-Sana/jan-sync"
                      target="_blank"
                      rel="noopener noreferrer"
                      class="flex items-center justify-between rounded-lg bg-slate-50 px-3.5 py-3 text-sm font-medium text-slate-600 shadow-sm ring-1 ring-slate-200 hover:bg-slate-100 hover:text-blue-600 active:scale-[0.98] transition-all"
                    >
